import {CardPacksType, packsApi, PacksResponseType, PacksType, SortingPacksType} from '../dal/packsAPI';
...
// thunk
export const getPacksTC = (payload?: PacksType):ThunkAction<void, RootStateType, unknown, AnyAction> =>
...
export const updatePack = (payload: CardPacksType): ThunkAction<void, RootStateType, unknown, AnyAction> => (dispatch, getState: () => RootStateType) => {
