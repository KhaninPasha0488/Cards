...
import {createPack} from '../../bll/packsReducer';
...
export const AddPack = React.memo((props: AddPackPropsType) => {
    ...
    const currentUserID = useSelector<RootStateType, string>((state) => state.profile._id);
    ...
    const onSaveClick = () => {
        dispatch(createPack(name, currentUserID)as any)
